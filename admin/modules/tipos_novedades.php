<?
	...
	$entidad->set("labelModule","Tipos Novedades");
...
// ---------- ATRIBUTOS          ----------------
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","clase");
	$atributo->set("label","Clase");
	$atributo->set("sqlType","smallint");
	$atributo->set("inputType","arraySelect");
	$atributo->set("arrayValues",array("1"=>"Personas", "2"=>"Vehículos", "3"=>"Mantenimiento"));
	$atributo->set("mandatory",TRUE);
	$atributo->set("searchable",TRUE);
	$atributo->set("browseable",TRUE);
	$atributo->set("shortList",TRUE);
	...
	$atributo=new attribute($entidad);
	$atributo->set("field","cambia_estado");
	$atributo->set("label","¿Cambia Estado?");
