...
if($micro["geometry"]==""){
	...
	echo "<input type=\"button\" value=\"Cerrar\" onClick=\"if(window.focus) window.opener.focus();window.close();\">";
	echo "<input type=\"button\" value=\"Cargar a partir de GPS\" onClick=\"window.location.href='record_route.php?id_micro=$frm[id_micro]';\">";
	die();
}
//preguntar($micro);
?>
	...
	<body onload="load()">
		<div align="center">
			...
			<form name="entryform">
				...
				<input type="button" value="Cargar a partir de GPS" onClick="window.location.href='record_route.php?id_micro=<?=$frm["id_micro"]?>';">
			</form>
		</div>
	</body>
</html>
