...
$titulos = array("PERÍODO", "META MÍNIMA", "META INTERMEDIA<br />(Entre 97% y 99.6%)", "META MÁXIMA<br />(Mayor a 99.6%)", "TCT + TTT (min)", "TO (min)", "INDICADOR");
if($html)
{
	echo '
	...
	while($uno <= $fecha["Sunday"])
	{
		...
		while($veh = $db->sql_fetchrow($qid))
		{
			...
			*/
			...
			El TTT es el tiempo que mantenimiento demora el vehículo en salir a cumplir una ruta, por ejemplo la ruta debio salir a las 6:00 am y el carro por algún trabajo de taller salio a las 6:30 entonces el tiempo de TTT es de 30 minutos.
			*/
...
tablita_titulos("DISPONIBILIDAD POR VEHÍCULO ",$inicio." / ".$final);
$titulos = array("VEHÍCULO", "META MÍNIMA", "META INTERMEDIA<br />(Entre 97% y 99.6%)", "META MÁXIMA<br />(Mayor a 99.6%)", "TCT+TTT (min)", "TO (min)", "INDICADOR");
if($html)
{
	echo '
