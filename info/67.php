...
?>
<table  align="center" style="border-spacing:1px 1px; border:solid #fff;">
	<tr bgcolor="#b2d2e1">
		<td valign="center">
			<div id="menu">
				<ul>
	...
	/* echo "SELECT n.id_nombre, n.id as id_nivel
					 ...
					 if ($dbcorporativo213->sql_numrows($qidCI)>0){									
								...
								?>
									...
									<iframe name="iframe" id="iframe" src="<?=$CFG->wwwroot.'/reportesgerenciales/rg1.php?id_nivel='.trim($in[1]).'&'.$post?>" class="iframe" scrolling="no"  frameborder="0" onload="redimensionariframe(this)"></iframe>
