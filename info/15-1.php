...
foreach($semana as $fecha)
{
	...
	//solicitadas
	$cond = " AND o.fecha_planeada::date>='".$ini."' AND o.fecha_planeada::date<='".$fin."'";
	$qidSol = $db->sql_row($consulta.$cond);

	$cond = " AND o.fecha_planeada::date>='".$ini."' AND o.fecha_planeada::date<='".$fin."' AND o.id_estado_orden_trabajo IN (SELECT id FROM mtto.estados_ordenes_trabajo WHERE cerrado) AND o.fecha_ejecucion_inicio::date>='".$ini."' AND o.fecha_ejecucion_inicio::date<='".$fin."'";
	$qidEje = $db->sql_row($consulta.$cond);

	$cond = " AND o.fecha_planeada::date>='".$ini."' AND o.fecha_planeada::date<='".$fin."' AND o.id_estado_orden_trabajo IN (SELECT id FROM mtto.estados_ordenes_trabajo WHERE cerrado) AND o.fecha_ejecucion_inicio::date NOT BETWEEN '".$ini."' AND '".$fin."'";
	...
	$cond = " AND o.fecha_planeada::date>='".$ini."' AND o.fecha_planeada::date<='".$fin."' AND o.id_estado_orden_trabajo NOT IN (SELECT id FROM mtto.estados_ordenes_trabajo WHERE cerrado)";
