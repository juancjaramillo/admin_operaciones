...
function listado($frm)
{
	...
	$cons = "SELECT n.id, e.nombre, to_char(n.hora_inicio,'YYYY/MM/DD') as fini, to_char(n.hora_inicio,'HH24:MI:SS') as hini, n.observaciones, 
		case when hora_fin IS NULL then '<a href=''javascript:edicion('||n.id||')''><img alt=''Editar'' src=''".$CFG->wwwroot."/admin/iconos/transparente/iconoeditar.gif'' border=''0''></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=''javascript:cerrar('||n.id||')''><img alt=''Cerrar'' src=''".$CFG->wwwroot."/admin/iconos/transparente/check_green.png'' border=''0''></a>' else '<a href=''javascript:edicion('||n.id||')''><img alt=''Editar'' src=''".$CFG->wwwroot."/admin/iconos/transparente/iconoeditar.gif'' border=''0''></a>' end as editar ".$camposAd."
			FROM novedades n
