...
<?
$strSQL="SELECT gid as id, id_micro, gid AS id_arco, codigo AS nombre, ST_AsGML($frm[field],7,0) as \"gmlgeom\" FROM micros_arcos_barrido WHERE $condicion ORDER BY id_micro";
