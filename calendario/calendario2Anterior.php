...
function mostrar_calendario($mes,$ano){
	...
	echo "<a style=color:white;text-decoration:none href=calendar.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	...
	echo "<a style=color:white;text-decoration:none href=calendar.php?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
	...
	echo "</tr>";
	echo "<tr><td colspan='7' align='center'><a href='javascript:devuelveFecha(0,0,0)' style='color:black;font-size:8pt;text-decoration:none;'>Reset</a></td>
		</tr>";
	echo "</table>";
}	
...
echo '
	...
	<tr><form action="calendar.php?' . $parametros_formulario . '" method="POST">';
echo '
...
function licencia($nombrecampo){
	...
	echo '
	<input type=button value="Ver información de licencia" valign="middle" class="buscador3" onclick="muestraLicencia(\''. $raiz.'\',\''. $nombrecampo .'\')">
	';	
}
