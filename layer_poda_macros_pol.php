...
<?
$strSQL="SELECT gid AS id, codmicro AS id_micro, codmicro AS nombre,
ST_AsGML($frm[field],7,0) as \"gmlgeom\" FROM poda WHERE
$condicion ORDER BY codmicro";
$qid=$db->sql_query($strSQL);
$i=0;
$totalClases=$db->sql_field("SELECT COUNT(DISTINCT codmicro) FROM poda WHERE $condicion");
