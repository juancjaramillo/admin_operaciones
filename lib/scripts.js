function abrirWHora(campo,formulario){
  ruta='/calendario/calendarAndHora.php?formulario='+formulario+'&nomcampo=' + campo + '&mode=editar';
  ventana = 'v_calendar';
...
function abrirSoloHora(campo,formulario){
  ruta='/calendario/soloHora.php?formulario='+formulario+'&nomcampo=' + campo;
  ventana = 'v_calendar';
  window.open(ruta,ventana,'scrollbars=yes,width=250,height=400,screenX=100,screenY=100');
}
...
function abrir(campo,formulario){
  ruta='/calendario/calendar.php?formulario='+formulario+'&nomcampo=' + campo;
  ventana = 'v_calendar';
...
function abrirCalendarioConModo(archivo,modo,esquema){
	ruta='/calendario/calendarWithMode.php?archivo=' + archivo + '&modo=' + modo + '&esquema=' + esquema;
	ventana = 'v_calendar';
	window.open(ruta,ventana,'scrollbars=yes,width=250,height=350,screenX=100,screenY=100');
}

function abrirCalendarioConModoModule(archivo,module){
	ruta='/calendario/calendarWithModeModule.php?archivo=' + archivo + '&module=' + module;
	ventana = 'v_calendar';
	window.open(ruta,ventana,'scrollbars=yes,width=250,height=350,screenX=100,screenY=100');
}
