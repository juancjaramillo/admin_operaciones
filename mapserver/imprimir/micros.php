...
{
	$capa = 'barrido_poligono'.$version;
	$flecheo = 'barrido_flecheo'.$version;
	$inifin = 'inifin'.$version;
	$codigo = $micro['codigo'];
	$mapa = 'tmp/'.$codigo.'.jpg';
	$pxAncho = 259.5;
	$pxAlto = 155;
...
$this->GetX();
    $this->Cell(65,10,'Micro : ' . $micro['micro'].'  [ '. $micro['km_bordillo'].' ]'.' '. $version.' ',1);
