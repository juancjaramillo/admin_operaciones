...
<?
$strSQL="SELECT gid AS id, macro AS id_micro, macro AS nombre,
ST_AsGML($frm[field],7,0) as \"gmlgeom\" FROM recoleccion_macros WHERE
$condicion ORDER BY macro";
$qid=$db->sql_query($strSQL);
$i=0;
$totalClases=$db->sql_field("SELECT COUNT(DISTINCT macro) FROM recoleccion_macros WHERE $condicion");
