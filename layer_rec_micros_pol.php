...
<?
$strSQL="SELECT id, id_micro, id_arco, nombre, ST_AsGML($frm[field],7,0) as \"gmlgeom\" FROM micros_arcos WHERE $condicion ORDER BY id_micro";
$qid=$db->sql_query($strSQL);
$i=0;
$totalClases=$db->sql_field("SELECT COUNT(DISTINCT id_micro) FROM micros_arcos WHERE $condicion");
